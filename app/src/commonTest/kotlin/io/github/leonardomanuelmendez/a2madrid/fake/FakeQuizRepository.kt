package io.github.leonardomanuelmendez.a2madrid.fake
...
class FakeQuizRepository(
    private val oppositions: List<Opposition> = emptyList(),
    ...
    override suspend fun getOppositions(): List<Opposition> = oppositions

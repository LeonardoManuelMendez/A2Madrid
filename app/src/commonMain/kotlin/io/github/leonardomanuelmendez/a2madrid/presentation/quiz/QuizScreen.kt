...
import io.github.leonardomanuelmendez.a2madrid.presentation.quiz.components.AnswerOptionCard
import io.github.leonardomanuelmendez.a2madrid.presentation.quiz.components.ExplanationCard
import io.github.leonardomanuelmendez.a2madrid.presentation.quiz.components.OptionState
      ...
      Column(
        ...
        if (uiState.isAnswerConfirmed) {
            ...
            ExplanationCard(
                ...
                onToggleExpanded = { explanationExpanded = !explanationExpanded },
            )
        }
      }
    }
...
private val previewQuestions = listOf(
    Question(
        ...
        explanation = Explanation(
            summary = "Madrid es la capital del Estado desde 1561.",
            points = listOf(
                ExplanationPoint(
                    term = "Barcelona, Valencia y Sevilla",
                    text = "son capitales de provincia y de comunidad autónoma, no del Estado.",
                ),
            ),
            source = ExplanationSource(
                label = "Constitución Española, art. 5",
                quote = "La capital del Estado es la villa de Madrid.",
            ),
        ),
    ),
)

 ...
 */
package io.github.leonardomanuelmendez.a2madrid.data.repository
...
class QuizRepositoryImpl(
    ...
    override suspend fun getOppositions(): List<Opposition> = listOf(
        Opposition(
            id = "c1_admin",
            name = "Cuerpo de Administrativos, de Administración General, Grupo C, Subgrupo C1",
            isActive = false
        ),
        Opposition(
            id = "c2_auxiliar",
            name = "Administración General, Grupo C, Subgrupo C2",
            isActive = true
        ),
        Opposition(
            id = "a1_tecnico",
            name = "Técnicos Superiores de Administración General - A1",
            isActive = false
        ),
        Opposition(
            id = "a2_gestion",
            name = "Técnicos de Gestión, A2",
            isActive = false
        )
    )
